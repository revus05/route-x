...
export const HeroSection = () => {
  return (
    <div
      className={
        "2xl:w-360 w-full 2xl:px-0 px-2 mx-auto xl:min-h-120 lg:min-h-105 md:min-h-95 sm:min-h-70 min-h-60 xl:flex xl:items-center xl:py-0 sm:py-20 pb-20 pt-4 relative"
      }
    >
